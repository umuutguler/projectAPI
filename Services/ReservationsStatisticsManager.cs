...
namespace Services
{
    public class ReservationsStatisticsManager : IReservationsStatisticsService
    {
        ...
        public Task<List<string>> ChairOccupancyRate(DateTime reservationStartDate, DateTime reservationEndDate, bool trackChanges)
        {
            throw new NotImplementedException();
        }

        public Task<List<string>> GenerateReservationReport(int tableId, DateTime startDate, DateTime endDate, bool trackChanges)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<ReservationInfo>> GetReservationsByTimeRange(DateTime startDate, DateTime endDate, bool trackChanges)
        {
            throw new NotImplementedException();
        }

        public Task<string> GetReservedChairCountByTableIdAsync(int id, DateTime startDate, DateTime endDate, bool trackChanges)
        {
            throw new NotImplementedException();
        }

        public Task<string> MostCancelledUserAsync(DateTime startDate, DateTime endDate, bool trackChanges)
        {
            throw new NotImplementedException();
        }

        public Task<string> MostReservedDepartmentAsync(DateTime startDate, DateTime endDate, bool trackChanges)
        {
            throw new NotImplementedException();
        }

        public Task<string> MostReservedUserAsync(DateTime startDate, DateTime endDate, bool trackChanges)
        {
            throw new NotImplementedException();
        }
        /*
